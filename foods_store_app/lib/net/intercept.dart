...
// import 'package:foods_store_app/util/jh_encrypt_utils.dart';
//
...
//     if (Constant.acceptDebug) {
//       content = JhEncryptUtils.decMd5Base64(content) as String;
//     }
//
//     /// 成功时，直接格式化返回
//     if (response.statusCode == ExceptionHandle.success ||
